...
function drawNumber($securityNumber, $fontMinSize, $fontMaxSize, $maxHorizAngle, $maxHorizAngle, $imgY, $imgX, &$image, $textColor, $font)
{
...
drawNumber($securityNumber, $fontMinSize, $fontMaxSize, $maxHorizAngle, $maxHorizAngle, $imgY, $imgX, $image, $textColor, $font);
